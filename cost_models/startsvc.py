...
#     iphone_list = []
#
#     with open('C:\\Users\\luky\\PycharmProjects\\tune\\cost_models\\store.csv', 'r', encoding='utf-8') as f:
#         data = csv.DictReader(f, delimiter=';')
#         for row in data:
...
#     with open('cost_models/store1.csv', 'w', encoding='utf-8') as f:
...
#     with open('cost_models/store.csv', 'w', encoding='utf-8') as f:
...
#
# def get_ff():
#     return open('cost_models/store1.csv', '+')
#
#
# def get_cvs_data1():
#     iphone_list = []
...
#                 if 'Quantity' in j and j['Quantity'] == '404':
#                     i['Quantity'] = '404'
#                 else:
#                     i['Quantity'] = 123
#                 # list_cvs.remove(i)
