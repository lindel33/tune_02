    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.TextField(verbose_name='Прайс')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.TextField(choices=[('Новое устройство, вскрыта упаковка. Не активировано.', 'Новый'), ('Новое устройство, выдано по гарантии взамен неисправному устройству в авторизованном сервисном центре (АСЦ) Apple. Абсолютно новое, не активированное.', 'Обменка'), ('Устройство в идеальном состоянии. Полностью работоспособно. Не имеет царапин и потертостей на корпусе и дисплее.', 'Как новый'), ('Устройство в отличном состоянии. Полностью работоспособно. На корпусе и/ или дисплее минимальные царапины и потертости. Без проблем закроются премиум защитным стеклом и чехлом.', 'Отличное'), ('Устройство в хорошем состоянии. Полностью работоспособно. На корпусе и/ или дисплее есть царапины и потертости. Без проблем закроются премиум защитным стеклом и чехлом.', 'Хорошее ')], help_text='Выбор сгенерирует шаблон', verbose_name='Состояние')),
